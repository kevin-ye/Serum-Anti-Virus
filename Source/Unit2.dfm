object Form2: TForm2
  ...
  Top = 0
  BorderIcons = []
  Caption = 'About Serum Anti-Virus V1.0'
  ClientHeight = 162
  ClientWidth = 515
  Color = clBtnFace
  ...
  object spSkinMemo1: TspSkinMemo
    ...
    Font.Style = [fsBold]
    Lines.Strings = (
      'About Serum Anti-Virus V1.3'
      '     Serum Anti-Virus is a tiny application '
      'which can kill normal virus'
      '  '
      '     Powered by '#21494#22025#24433'Ye JiaYing'
      '     Website: www.icybit.com'
      '     Email: pokemon@163.com  ')
    ParentFont = False
    ReadOnly = True
